  ...
  <div class="main-right r">
    ...
    <div class="m_m tab">
    	...
    	<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_1">
    		<tr>
    			<td colspan="7">
    				<form action="userapprove/list.htm?pu.pageNum=1" method="post" id="search">
    	...
    	<div class="page" align="left">
    		<a href="javascript:to_page('userapprove/list.htm?pu.pageNum=1','search')">首页</a>
    		<a href="javascript:to_page('userapprove/list.htm?pu.pageNum=${pu.pageNum-1}','search')">上一页</a>
    		<c:forEach items="${pu.pageList}" var="p">
    			...
    			<c:if test="${p != pu.pageNum}">
    				<a href="javascript:to_page('userapprove/list.htm?pu.pageNum=${p}','search')">&nbsp; ${p} &nbsp;</a>
    			</c:if>
    		</c:forEach>
    		<a href="javascript:to_page('userapprove/list.htm?pu.pageNum=${pu.pageNum+1}','search')">下一页</a>
    		<a href="javascript:to_page('userapprove/list.htm?pu.pageNum=${pu.pageCount}','search')">尾页</a>
    	</div>
    </div>
  </div>
  <div class="clear"></div>
