    		...
    		<form action="user/add.htm" method="post">
	    		...
	    		<table width="100%" border="0" cellpadding="0" cellspacing="0" class="tb_2">
	    			...
	    			<tr>
	    				...
	    				<td><input type="text" name="us.loginName" class="inp1"  maxlength="80" datatype="Require" value=""  /></td>
	    			</tr>
	    			<tr>
	    				<th><span class="red">*</span> 请输入用户姓名：</th>
	    				<td><input type="text" name="us.userName" class="inp1"  maxlength="80" datatype="Require" value=""  /></td>
	    			</tr>
	    			<tr>
